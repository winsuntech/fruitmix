...
describe("test files", function() {
  ...
  it("GET /media should return 200", function(done) {
    request(app)
      .get('/media')
  ...
  it("GET /media/333333?type=listdetail should return 200 ", function(done) {
    request(app)
      .get('/media/333333?type=listdetail')
  ...
  it("GET /media/333333?type=photo should return 404 if missing target ", function(done) {
    request(app)
      .get('/media/333333?type=photo')
      .set('Accept', 'application/json')
      .set('Authorization', 'JWT eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1dWlkIjoiYzMxYTJlOTktOTg3ZC00ZjY1LTk1NTktMjJlMjJmZjYwM2RhIn0.C7j5pmnGXSr2ZB2NTHJHMNw2HGDrZlmgXbNa-TtSUoU')
      .expect(404, done);
  });

  it("GET /media/333333?type=photo&target=2323 should return 404 if target is invalid", function(done) {
    request(app)
      .get('/media/333333?type=photo&target=2323')
      .set('Accept', 'application/json')
      .set('Authorization', 'JWT eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1dWlkIjoiYzMxYTJlOTktOTg3ZC00ZjY1LTk1NTktMjJlMjJmZjYwM2RhIn0.C7j5pmnGXSr2ZB2NTHJHMNw2HGDrZlmgXbNa-TtSUoU')
      .expect(404, done);
  });

  it("GET /media/?type=photo should return 200 if success", function(done) {
    request(app)
